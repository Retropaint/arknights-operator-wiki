...
import { Filter, FilterCategory, GeneratedFilter } from './interfaces/operator-filter';
...
export class FilterService {
  ...
  private checkFilter(filters: Filter[], property: string, iconLink: string) {
  ...
  private checkBranchFilter(filters: Filter[], branch: string, iconLink: string, opClass: string, associatedClasses: any) {
  ...
  private sortCategory(filterName: string) {
    this.refreshBranchHighlights();
  ...
  private refreshGeneratedFilters() {
  ...
  private branchHighlight(branch: string, assClass: string) {
  ...
  private refreshBranchHighlights() {
